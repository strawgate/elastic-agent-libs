...
func TestDeepCopyUpdateEquivalence(t *testing.T) {
	src := M{
		"cloud": M{
			"provider": "aws",
			"region":   "us-east-1",
...
func TestDeepCopyUpdateIndependentEvents(t *testing.T) {
	shared := M{
		"agent": M{"id": "agent-123", "version": "8.12.0"},
	}

	event1 := M{"message": "event1"}
	event1.DeepCopyUpdate(shared)

	event2 := M{"message": "event2"}
	event2.DeepCopyUpdate(shared)
...
func TestDeepCopyUpdateMergesExistingMaps(t *testing.T) {
	dst := M{
...
func TestDeepCopyUpdateOverwrites(t *testing.T) {
	dst := M{"key": "old"}
	src := M{"key": "new"}
...
func TestDeepCopyUpdateDeepNesting(t *testing.T) {
	src := M{
		"a": M{"b": M{"c": M{"d": "deep"}}},
	}
	srcCopy := src.Clone()
...
// --- DeepCopyUpdateNoOverwrite ---

func TestDeepCopyUpdateNoOverwriteSkipsExisting(t *testing.T) {
	dst := M{
...
func TestDeepCopyUpdateNoOverwriteNoAliasing(t *testing.T) {
...
func TestDeepCopyUpdateNoOverwriteEquivalence(t *testing.T) {
	src := M{
	...
	dst2.DeepCopyUpdateNoOverwrite(src)
...
func TestDeepCopyUpdateEmptySource(t *testing.T) {
	dst := M{"key": "value"}
	dst.DeepCopyUpdate(M{})
	assert.Equal(t, M{"key": "value"}, dst)
}

func TestDeepCopyUpdateMapStringInterface(t *testing.T) {
